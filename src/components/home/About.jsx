      ...
      <div className="container mx-auto flex flex-col-reverse md:flex-row items-center justify-between">
        ...
        >
          ...
          >
            ...
            Dynamic frontend wizard skilled in transforming design visions into
            captivating user interfaces. Expertise in Tailwind CSS, JavaScript,
            React, Next, Express, MongoDB. Proven collaborator, elevating
            cross-functional teamwork to ensure seamless, high-performance web
            experiences. Design-oriented, detail-focused, and committed to
            staying ahead of the curve in evolving web trends.Detail-oriented
